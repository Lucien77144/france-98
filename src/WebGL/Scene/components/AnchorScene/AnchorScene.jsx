...
import ParticleScene from "../ParticuleMesh/ParticuleScene";
          ...
          <group name="Scene">
            ...
            >
              ...
              <Stadium
                ...
                actions={actions}
              ></Stadium>
              <Goal1 nodes={nodes} actionBall={actions}></Goal1>
              <Goal2 nodes={nodes} actionBall={actions}></Goal2>
              <Goal3 nodes={nodes} actionBall={actions}></Goal3>
